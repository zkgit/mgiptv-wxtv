define(['angular','size', 'fun'], function(angular, tpl) {
    ...
    function controller($scope, $rootScope, $http,$state) {
        ...
        $scope.list={
            ...
            'film_b':{
                ...
                'list':[
                    ...
                    {
                        'info':'2.激活成功后可享受电影频道、高清影院、好莱坞、电视剧频道、高清剧场、鼎级美剧、亚洲剧场等产品包免费观看权益。'
                    },
                    {
                        'info':'3.从激活日起，权益有效使用期为365天。'
                    }
        ...
        // $scope.erma=false;
        $scope.buy=function () {
            $http.post(webset.base+'wxpay/qrCodePayToActivtionCode?&openId='+$scope.openid+'&type='+$scope.sc.type, {}).success(function (res) {
