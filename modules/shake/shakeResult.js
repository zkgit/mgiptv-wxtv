define(['angular','size', 'fun'], function(angular, tpl) {
	...
	function controller($scope, $http, $rootScope) {
		...
		$rootScope.htmlname = 'shakeResult bgcfff pb10';
...
//
		...
		$scope.addhistory = function() {
			...
			urlscy = webset.apiurl + 'user/saveUsualChannel.json?appKey=D176EB3E8B1F044B&appScrect=64&behaviorType=usualChannel&token=' + $scope.token + '&behaviorJson=' + JSON.stringify(behaviorJson);
